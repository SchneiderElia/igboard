              ...
              case 'bauhaus_structure':
                return (
                  <div className="w-full h-full flex flex-col p-16">
                    <div className="flex h-1/2 border-b-8" style={{ borderColor: colors.accent }}>
                      <div className="w-2/3 border-r-8 pr-12 flex items-end pb-8" style={{ borderColor: colors.accent }}>
                        <h1 className="text-[120px] leading-[0.8] font-black uppercase" style={{ fontFamily: fontPair.headline, color: colors.accent, textWrap: 'balance' }}>
                          {content.headline}
                        </h1>
                      </div>
                      <div className="w-1/3 pl-12 flex items-start pt-8">
                        <h2 className="text-[35px] font-bold uppercase leading-tight" style={{ fontFamily: fontPair.body }}>
                          {content.subheadline}
                        </h2>
                      </div>
                    </div>
                    <div className="flex h-1/2 pt-12">
                      <div className="w-1/2"></div>
                      <div className="w-1/2 flex flex-col justify-between">
                        <div>
                          {Array.isArray(content.body) ? content.body.map((p, i) => <p key={i} className="text-[28px] mb-6 text-justify" style={{ fontFamily: fontPair.body }}>{p}</p>) : <p className="text-[28px] text-justify" style={{ fontFamily: fontPair.body }}>{content.body}</p>}
                        </div>
                        <div className="text-[45px] font-black uppercase text-right" style={{ color: colors.accent, fontFamily: fontPair.headline }}>
                          {content.cta} ⬛
                        </div>
                      </div>
                    </div>
