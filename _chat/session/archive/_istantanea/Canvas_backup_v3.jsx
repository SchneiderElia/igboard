...
// ═══════════════════════════════════════════════════════════════
function LayoutRouter({ layout, content, colors, fontPair, templateId }) {
...
export default function Canvas({ design }) {
  ...
  return (
    <div ref={containerRef} className="w-full flex justify-center items-center p-4 overflow-hidden">
      ...
      <div style={{ width: 1080 * scale, height: 1350 * scale }} className="flex justify-center items-center">
        ...
        >
          ...
          <DecoratorRenderer decorators={layout.decorators} colors={colors} />

          {/* ICONA DI SUPPORTO (scelta dall'AI — z-index 0) */}
          <IconRenderer icon={design.icon} colors={colors} />

          {/* LAYOUT ROUTER (z-index 1 — sopra i decoratori) */}
